...
CREATE TABLE `blog`  (
  ...
  `recommend` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '推荐',
...
-- Records of blog
-- ----------------------------
INSERT INTO `blog` VALUES ('4028ba816f2c54ae016f2c56e9de0000', 39, '/uploads/20191222/e9784f39a44f4da69a36e47c51c3d8e6.html', '0', 39, '<div class=\"image-package\"><img style=\"max-width:100%;\" class=\"\" data-src=', '正值冬季大雪纷飞时，想不想拍出雪天电影感照片？ ', '2019-12-22 06:41:31', '0');
INSERT INTO `blog` VALUES ('4028ba816f2c5d35016f2c67eae30000', 39, '/uploads/20191222/87947b04c74c42b2822c2467751eb91f.html', '0', 39, '<p style=\"text-align: left;\"><span style=\"font-family: 宋体, SimSun; font-si', '最想旅行的地方是爱人的心：4步教你拍出浪漫情侣写真 ', '2019-12-22 07:00:05', '0');
INSERT INTO `blog` VALUES ('4028e4816f2262e0016f227ff30f0000', 1, '/uploads/20191220/5505e2f62fa04d94b659b371b53af64c.html', '0', 1, '<span class=\"bjh-p\">有人说，怎么才可以拍出摄影大师才能拍出的照片？我想说掌握了这6个摄影技巧，让你成为摄影大师。</spa', '6个摄影技巧，让你成为摄影大师', '2019-12-20 08:50:08', '0');
INSERT INTO `blog` VALUES ('4028e4816f2793f7016f279554810000', 1, '/uploads/20191221/e034b2c1754d4594bea3521f11be5faf.html', '0', 1, '<div class=\"img-container\"><img class=\"large\" data-loadfunc=\"0\" src=\"https', '摄影构图的三大要素，学会强化视觉主题，易记易用', '2019-12-21 08:31:36', '0');
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (1, '我只是想试试', '2019-12-23 15:48:58', 1, '4028ba816f2c54ae016f2c56e9de0000', 39);
...
-- Records of draw
-- ----------------------------
INSERT INTO `draw` VALUES (1, 1, '0', '/uploads/20191223/112a9188be0b401b8ab6571c59996d9c.json', 1, 'test1', '2019-12-23 08:12:01', '0');
INSERT INTO `draw` VALUES (2, 1, '0', '/uploads/20191223/633f506f86af4cceb55ccf781bc9e04e.json', 1, 'test2', '2019-12-23 08:50:17', '0');
...
CREATE TABLE `feedback`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `title` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'title',
  `mail` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'mail',
  `content` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `feedback_time` datetime(0) NOT NULL COMMENT '反馈的时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin', '2019-11-17 12:06:39', '我是老板你懂吗!', '132', '1');
